 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "        #store the data in the new variable for later use\n",
    ...
    "        reason_solumns = pd.get_dummies(df['Reason for Absence'], drop_first = True)\n",
    "        \n",
    ...
    "        #note: there is a more universal version of this code, however the followinf will best suit for our purposes\n",
